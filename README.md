...
## Before launch
1. Replace the image placeholders with real LMS / Continuo / audience photography.
2. Replace the Continuo video placeholder link on `live-music.html`.
3. Confirm the final PaoliFest URL.
4. Add your real donation destination on `donate.html`.
5. Review any factual wording you want adjusted before publication.
